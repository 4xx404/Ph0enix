...
class CoreConfig:
    def __init__(self):
        ...
        self.FailWords = ["oops", "sorry", "does not exist", "doesnt exist", "doesn't exist", "no user", "no profile", "page not found", "page cannot be found", "this page is no longer available", "no such user", "404"]
